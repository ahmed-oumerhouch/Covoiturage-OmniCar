        ...
        <li class="push"> 
          <div class="dropdown" style="float:right;">
            ...
            <div class="dropdown-content">
              ...
              <a href="?action=afficher&page=page_mes_messages">Mes Messages</a>
        ...
        <div class="modifierTrajet">
          <table cellpadding="10">          
            ...
            <tr>
              ...
              <td><input id="codePostalmdfg" name="codePostalmdfg"   class="inputPop" type="text" placeholder="Code postal" value="'.ConvertCodePostale::formatCode($La_publications->getCodePostal()) .'"></td>
            </tr>
            <tr>
