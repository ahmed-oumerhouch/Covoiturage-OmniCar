...
class mesMessagesEnvoye implements Action,PRG{
...
$_SESSION['AfficherMessageContenu'] = "cliquer sur un message reçu pour afficher son contenue";
            ...
            $convo = MessageDAO::trouverParProvenance($membre);

            if($convo != null)
            {
                foreach($convo as $p){
                             array_push($listeid,$p->getProvenance());
                }
